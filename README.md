...
~~~sh
# getting the code
git clone git@github.com:nko4/nappytime.git && cd ./nappytime/

# developing
npm install
npm start

# deploying (to http://nappytime.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@nappytime.2013.nodeknockout.com
ssh root@nappytime.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@nappytime.2013.nodeknockout.com
ssh -i ./id_deploy root@nappytime.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/nappytime" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
